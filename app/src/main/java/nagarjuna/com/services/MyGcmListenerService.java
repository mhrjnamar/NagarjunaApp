...
import nagarjuna.com.nagarjunaapp.Notifications;
...
EventsDatabase database;
    ...
    public void onMessageReceived(String from, Bundle data) {
        ...
        database = new EventsDatabase(MyGcmListenerService.this);
        database.insertNotifyMsg(message);
        ...
        manager.storeNotificationMsg(message);
